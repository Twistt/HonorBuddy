...
namespace Eclipse
{
    ...
    public static class UIHooks
    {
        ...
        public static void AttachQuestEvents()
        {
            ...
            Lua.Events.AttachEvent("QUEST_WATCH_UPDATE", OnQuestUpdate);
        }

        public static void AttachGroupEvents()
        {
        ...
        public static void DetatchGroupEvents()
        {
        ...
        public static void DetatchQuestEvents()
        {
            EC.Log("Deattaching quest events.");
        ...
        private static void OnQuestUpdate(object sender, LuaEventArgs args)
        {
            EC.Log("Quest is one item closer to beign done...");
            if (EC.ActiveQuestOrder.type == Models.QuestOrder.QOType.Objective && EC.ActiveQuestOrder.objectiveType == Models.QuestObjective.QuestType.CollectItem) {
                EC.ActiveQuestOrder.CurrentCollectCount++;
                if (EC.ActiveQuestOrder.CurrentCollectCount >= EC.ActiveQuestOrder.CollectCount) EC.ActiveQuestOrder.status = Models.QuestStatus.Complete;
            }
            if (EC.ActiveQuestOrder.type == Models.QuestOrder.QOType.Objective && EC.ActiveQuestOrder.objectiveType == Models.QuestObjective.QuestType.KillMob)
            {
                EC.ActiveQuestOrder.CurrentKillCount++;
                if (EC.ActiveQuestOrder.CurrentKillCount >= EC.ActiveQuestOrder.KillCount) EC.ActiveQuestOrder.status = Models.QuestStatus.Complete;
            }
            if (EC.ActiveQuestOrder.type == Models.QuestOrder.QOType.Objective && EC.ActiveQuestOrder.objectiveType == Models.QuestObjective.QuestType.KillAndLootItem)
            {
                EC.ActiveQuestOrder.CurrentCollectCount++;
                if (EC.ActiveQuestOrder.CurrentCollectCount >= EC.ActiveQuestOrder.CollectCount) EC.ActiveQuestOrder.status = Models.QuestStatus.Complete;
            }
            if (EC.ActiveQuestOrder.type == Models.QuestOrder.QOType.Objective && EC.ActiveQuestOrder.objectiveType == Models.QuestObjective.QuestType.HangOutWithNPC)
            {
                EC.ActiveQuestOrder.CurrentCollectCount++;
                if (EC.ActiveQuestOrder.CurrentCollectCount >= EC.ActiveQuestOrder.CollectCount) EC.ActiveQuestOrder.status = Models.QuestStatus.Complete;
            }
        ...
        #endregion
        public static void OnPartyInvite(object sender, LuaEventArgs args)
        {
        ...
        public static void OnReadyCheckHandler(object sender, LuaEventArgs args)
        {
            CommsCommon.Log("Ready check has been initiated by " + args.Args[0]);
            Lua.DoString("RunMacroText(\"/click ReadyCheckFrameYesButton\")");
        }

        public static void OnRecurrectionHandler(object sender, LuaEventArgs args)
        {
